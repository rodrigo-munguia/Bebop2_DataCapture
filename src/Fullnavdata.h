...
public:
    ...
    bool Datacapture = false; // Flag for storing data
...
private:
    ...
    std::ofstream fileRangeSensor;  // RodrigoM
	std::ofstream filePressureSensor;  // RodrigoM
    ...
    //friend bool Drone::useFullNavdata();  //RodrigoM
    friend bool vpRobotBebop2::useFullNavdata();    // RodrigoM
};
